...
* **Active Storage ファイル**: `volumes: - tech_notes_storage:/rails/storage`
  * Active Storage のアップロードファイル（OGP 画像・プロフィール画像など）を永続化する Docker named volume。
...
volumes:
  - "tech_notes_storage:/rails/storage"
