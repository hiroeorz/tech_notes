...
# docker build -t hiroe_tech_notes .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name hiroe_tech_notes hiroe_tech_notes
...
# Precompiling assets for production without requiring secret RAILS_MASTER_KEY or APP_HOST
