...
class Tag
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Tag` class because it declared `has_many :post_tags`.
    ...
    # This method is created by ActiveRecord on the `Tag` class because it declared `has_many :posts, through: :post_tags`.
