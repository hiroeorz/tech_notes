...
class Comment
  ...
  module GeneratedAttributeMethods
    ...
    def author_name_before_last_save; end

    sig { returns(T.untyped) }
    def author_name_before_type_cast; end

    sig { returns(T::Boolean) }
    def author_name_came_from_user?; end

    sig { returns(T.nilable([::String, ::String])) }
    def author_name_change; end

    sig { returns(T.nilable([::String, ::String])) }
    def author_name_change_to_be_saved; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def author_name_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::String)) }
    def author_name_in_database; end

    sig { returns(T.nilable([::String, ::String])) }
    def author_name_previous_change; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def author_name_previously_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::String)) }
    def author_name_previously_was; end

    sig { returns(T.nilable(::String)) }
    def author_name_was; end

    sig { void }
    def author_name_will_change!; end
    ...
    sig { returns(T.nilable([::String, ::String])) }
    def saved_change_to_author_name; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def saved_change_to_author_name?(from: T.unsafe(nil), to: T.unsafe(nil)); end
    ...
    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def will_save_change_to_author_name?(from: T.unsafe(nil), to: T.unsafe(nil)); end
