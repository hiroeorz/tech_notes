...
env | grep -E '^(POSTGRES_PASSWORD|KAMAL_REGISTRY_PASSWORD|RAILS_MASTER_KEY|CLOUDFLARE_|GOOGLE_SITE_VERIFICATION|IMAGE|SERVER_IP|REGISTRY_USERNAME|SSH_USER|POSTGRES_USER|APP_HOST)'
```
