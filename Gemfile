...
gem "propshaft"
# Use sqlite3 for development and test databases
gem "sqlite3", ">= 2.1", group: %i[ development test ]

# Use PostgreSQL as the production database (Kamal accessory)
gem "pg", "~> 1.5"
...
# Model Context Protocol SDK for exposing tools over the MCP protocol
gem "mcp", "~> 1.6"

# OAuth authorization server for MCP clients (Gemini integration)
gem "doorkeeper", "~> 5.9"
